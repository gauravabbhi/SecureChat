...
//  ChatAppSwiftUI
//
//  Created by Gaurav Abbhi on 25/5/2024.
//
...
struct SettingsView: View {
    ...
    var body: some View {
        VStack {
            ...
            VStack(spacing: 32) {
                OptionView(title: "Name", subtitle: user.fullName, imageName: "person.fill",secondSubtitle: "This is not your username or pin. This name will be visible to your SecureChat contacts.")
                OptionView(title: "About", subtitle: "Hey there! I am using SecureChat.", imageName: "exclamationmark.circle")
